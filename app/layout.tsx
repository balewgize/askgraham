  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`} suppressHydrationWarning>
      ...
      <body className="flex min-h-full flex-col bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
        <header className="sticky top-0 z-40 border-b border-black/10 bg-white/90 backdrop-blur dark:border-white/10 dark:bg-zinc-950/90">
          <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-2.5">
            <Link href="/" className="font-serif text-lg font-bold tracking-tight" style={{ fontFamily: "Georgia, serif" }}>
              Ask Graham
            </Link>
        ...
        <footer className="border-t border-black/10 py-4 text-center text-[11px] text-zinc-400 dark:border-white/10">
          Personal learning tool · essays by Paul Graham (paulgraham.com) · {new Date().getFullYear()}
        </footer>
      </body>
    </html>
  );
